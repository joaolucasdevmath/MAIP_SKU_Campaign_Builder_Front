    ...
    <Box>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Grid container spacing={3}>
          ...
          {/* Campos dinâmicos: Tipo e Objetivo da Campanha lado a lado */}
          ...
          {/* Oferta(s) e Código da Campanha lado a lado */}
          {offerField && (
            <Grid item xs={12} md={6}>
          ...
          {/* Tipo de Disparo - linha completa */}
          <Grid item xs={12}>
            {channelField && (
          ...
          {/* Campo de Quantidade de Disparos - aparece quando há canais selecionados */}
              ...
              <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
                ...
                <Grid container spacing={2}>
                  {selectedChannels.map((channelValue: string) => {
                    const channelOption = channelField?.values?.find((item: any) => 
                      (item.value || item.id || item) === channelValue
                    );
                    const channelLabel = channelOption?.label || channelOption?.value || channelValue;
          ...
          {/* Campo estático: Campanha Contínua */}
          <Grid item xs={12}>
            <RHFCheckbox
              name="is_continuous"
          ...
          <Grid item xs={12}>
            <Box display="flex" justifyContent="space-between" mt={3}>
              ...
              <Button variant="contained" color="primary" type="submit" sx={{ backgroundColor: '#093366', '&:hover': { backgroundColor: '#07264d' } }}>
                Próximo
              </Button>
            </Box>
          </Grid>
